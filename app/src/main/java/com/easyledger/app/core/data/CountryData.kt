...
data class Country(val name: String, val code: String, val iso2: String)

object CountryData {
    // ISO 3166 country names with primary E.164 calling codes
    // Source: ITU/E.164 consolidated public data (manually compiled)
    val countries: List<Country> = listOf(
        Country("Afghanistan", "+93", "AF"),
        Country("Albania", "+355", "AL"),
        Country("Algeria", "+213", "DZ"),
        Country("American Samoa", "+1-684", "AS"),
        Country("Andorra", "+376", "AD"),
        Country("Angola", "+244", "AO"),
        Country("Anguilla", "+1-264", "AI"),
        Country("Antigua and Barbuda", "+1-268", "AG"),
        ...
        Country("British Virgin Islands", "+1-284", "VG"),
        ...
        Country("Congo (Republic)", "+242", "CG"),
        Country("Congo (DRC)", "+243", "CD"),
        Country("Cook Islands", "+682", "CK"),
        Country("Costa Rica", "+506", "CR"),
        Country("Côte d’Ivoire", "+225", "CI"),
        Country("Croatia", "+385", "HR"),
        Country("Cuba", "+53", "CU"),
        Country("Curaçao", "+599", "CW"),
        Country("Cyprus", "+357", "CY"),
        Country("Czechia", "+420", "CZ"),
        Country("Denmark", "+45", "DK"),
        Country("Djibouti", "+253", "DJ"),
        Country("Dominica", "+1-767", "DM"),
        Country("Dominican Republic", "+1-809", "DO"),
        ...
        Country("Grenada", "+1-473", "GD"),
        Country("Guadeloupe", "+590", "GP"),
        Country("Guam", "+1-671", "GU"),
        Country("Guatemala", "+502", "GT"),
        Country("Guernsey", "+44-1481", "GG"),
        ...
        Country("Isle of Man", "+44-1624", "IM"),
        Country("Israel", "+972", "IL"),
        Country("Italy", "+39", "IT"),
        Country("Jamaica", "+1-876", "JM"),
        Country("Japan", "+81", "JP"),
        Country("Jersey", "+44-1534", "JE"),
        ...
        Country("Northern Mariana Islands", "+1-670", "MP"),
        ...
        Country("Puerto Rico", "+1-787", "PR"),
        Country("Qatar", "+974", "QA"),
        Country("Réunion", "+262", "RE"),
        Country("Romania", "+40", "RO"),
        Country("Russia", "+7", "RU"),
        Country("Rwanda", "+250", "RW"),
        Country("Saint Kitts and Nevis", "+1-869", "KN"),
        Country("Saint Lucia", "+1-758", "LC"),
        Country("Saint Vincent and the Grenadines", "+1-784", "VC"),
        Country("Samoa", "+685", "WS"),
        Country("San Marino", "+378", "SM"),
        Country("São Tomé and Príncipe", "+239", "ST"),
        ...
        Country("Trinidad and Tobago", "+1-868", "TT"),
        Country("Tunisia", "+216", "TN"),
        Country("Turkey", "+90", "TR"),
        Country("Turkmenistan", "+993", "TM"),
        Country("Turks and Caicos Islands", "+1-649", "TC"),
